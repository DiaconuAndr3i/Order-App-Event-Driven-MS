...
public class PlaceOrderProducer {
    private static Logger LOGGER = LoggerFactory.getLogger(PlaceOrderProducer.class);
    private NewTopic topic;
    private KafkaTemplate<String, OrderEvent> kafkaTemplate;

    public PlaceOrderProducer(NewTopic topic, KafkaTemplate<String, OrderEvent> kafkaTemplate){
        this.topic = topic;
